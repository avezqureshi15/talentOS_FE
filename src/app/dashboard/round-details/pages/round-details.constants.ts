...
export const MOCK_EVALUATION: CandidateEvaluationData = {
  ...
  hrDecision: "review",
  jdFit: "Strong overlap on IAM governance and security controls; weaker on GCP-native hybrid networking.",
  strengths: [
    "Clear explanations of IAM least-privilege concepts",
    "Correct use of Secret Manager and Cloud Armor",
    "Good awareness of load balancer + SSL termination",
  ],
  weaknesses: [
    "Confused GCP with AWS/Azure services (Route 53, ExpressRoute)",
    "Deferred core network diagnostics to other teams",
    "No hands-on experience with Cloud KMS / CMEK",
  ],
  transcriptSummary: "The conversation covered IAM, system design, and a hybrid-network troubleshooting scenario. The candidate showed platform confusion and deferred several core technical questions.",
  createdAt: "2026-08-01T09:00:00Z",
  startedAt: "2026-08-01T09:05:00Z",
  completedAt: "2026-08-01T09:45:00Z",
  expiresAt: "2026-08-08T09:00:00Z",
  rubricTotal: 25,
  questionScores: [
    {
      id: "q1",
      question: "Explain GCP IAM policies and how they differ from AWS IAM.",
      score: 8,
      earnedScore: 3,
      notes: "Misapplied IAM Conditions to password expiry and suggested super-admin roles.",
      candidateAnswer: "IAM policies are attached to resources and use a hierarchy of organization, folder, and project.",
      expectedPoints: ["Hierarchy explanation", "Least privilege", "IAM Conditions"],
      candidatePoints: ["Hierarchy explanation"],
      pointCoverage: [
        { point: "Hierarchy explanation", covered: true },
        { point: "Least privilege", covered: false },
        { point: "IAM Conditions", covered: false },
      ],
    },
    {
      id: "q2",
      question: "Design a highly available three-tier web application on GCP.",
      score: 10,
      earnedScore: 5,
      notes: "Confused GCP with AWS/Azure and misstated storage replication.",
      candidateAnswer: "Use Cloud Load Balancing, Compute Engine, and Cloud SQL with multi-region failover.",
      expectedPoints: ["Load balancing", "Multi-region failover", "Secret management"],
      candidatePoints: ["Load balancing", "Secret management"],
      pointCoverage: [
        { point: "Load balancing", covered: true },
        { point: "Multi-region failover", covered: false },
        { point: "Secret management", covered: true },
      ],
    },
    {
      id: "q3",
      question: "Diagnose intermittent 50% packet loss to Cloud SQL over VPN.",
      score: 7,
      earnedScore: 2,
      notes: "Refused BGP/Cloud Router questions and deferred to the networking team.",
      candidateAnswer: "I would check network connectivity, VPC firewall rules, and Cloud SQL private IP.",
      expectedPoints: ["VPC Flow Logs", "BGP route priority", "Connectivity Tests"],
      candidatePoints: ["VPC Flow Logs"],
      pointCoverage: [
        { point: "VPC Flow Logs", covered: true },
        { point: "BGP route priority", covered: false },
        { point: "Connectivity Tests", covered: false },
      ],
    },
  ],
};
