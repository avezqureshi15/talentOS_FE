...
export const APPLICANT_LABELS = {
  ...
  SOURCE: "Source",
  NO_COVER_LETTER_TITLE: "No Cover Letter Provided",
  NO_COVER_LETTER_DESC: "The candidate did not submit a cover letter for this position.",
  NO_AI_SUMMARY_TITLE: "AI Summary Not Generated",
  NO_AI_SUMMARY_DESC: "An AI summary hasn't been generated for this candidate yet.",
