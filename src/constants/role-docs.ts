...
export const ROLE_DOCS_FEATURES: RoleDocsFeature[] = [
  {
    ...
    permissions: { superadmin: true, account_admin: true, job_owner: true, reviewer: true },
  },
  {
    ...
    permissions: { superadmin: true, account_admin: true, job_owner: true, reviewer: false },
  },
  {
    id: "export-reports",
  ...
  },
  {
    ...
    permissions: { superadmin: true, account_admin: true, job_owner: false, reviewer: false },
  },
  {
